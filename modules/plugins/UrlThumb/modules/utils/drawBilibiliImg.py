...
def binfo_image_create(video_info, save_path: str):
    ...
    tiem_font = ImageFont.truetype('modules/resource/font/sarasa-mono-sc-bold.ttf', 30)
    ...
    title_font = ImageFont.truetype('modules/resource/font/sarasa-mono-sc-bold.ttf', 25)
    ...
    dynamic_font = ImageFont.truetype('modules/resource/font/sarasa-mono-sc-semibold.ttf', 18)
    ...
    # 视频数据
    icon_font = ImageFont.truetype('modules/resource/font/vanfont.ttf', 46)
    ...
    name_font = ImageFont.truetype('modules/resource/font/sarasa-mono-sc-bold.ttf', 24)
    up_title_font = ImageFont.truetype('modules/resource/font/sarasa-mono-sc-bold.ttf', 20)
    follower_font = ImageFont.truetype('modules/resource/font/sarasa-mono-sc-semibold.ttf', 22)
    ...
    for up in up_list:
        ...
        draw.rectangle((60, 10 + (i * 120), 73 + up_title_size_x, 18 +
                        (i * 120) + up_title_size_y), "white", icon_color, 3)
    ...
    # Logo
    # LOGO \uE725
    logo_font = ImageFont.truetype('modules/resource/font/vanfont.ttf', 100)
